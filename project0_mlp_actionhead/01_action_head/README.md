...
**运行：**
```
python project0_mlp_actionhead/01_action_head/scripts/01_data_augment.py
```
...
python project0_mlp_actionhead/01_action_head/scripts/02_train.py
```
- 支持断点续训，ctrl+c暂停。
...
```zsh
tensorboard --logdir=project0_mlp_actionhead/01_action_head/runs/
```

```zsh
python project0_mlp_actionhead/01_action_head/scripts/03_run_robot.py
```
