...
All the environments are registered in the `basic_grasp` extension. They start
...
import basic_grasp.tasks  # noqa: F401


def main():
    """Print all environments registered in `basic_grasp` extension."""
